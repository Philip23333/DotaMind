...
> 本文描述当前工作树已经实现的 V3.2-1 单 Attempt 架构，并单独标明后续
...
flowchart TD
    ...
    Answer -->|"answer error"| RunFinalize
    Critic --> RunFinalize
...
| Prompt Registry/version/hash | 未实现 | V3.2-2 |
