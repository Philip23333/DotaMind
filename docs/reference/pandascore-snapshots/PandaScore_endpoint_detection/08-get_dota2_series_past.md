...
- **Title:** Get past Dota 2 series
- **Method:** GET
- **API path:** `/dota2/series/past`
- **Requested path:** `/dota2/series/past`
- **Reference URL:** https://developers.pandascore.co/reference/get_dota2_series_past.md
...
- Collected at: 2026-09-02T10:37:46.947073Z
