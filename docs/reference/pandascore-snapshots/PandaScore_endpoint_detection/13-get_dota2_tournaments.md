...
- **Title:** List Dota 2 tournaments
- **Method:** GET
- **API path:** `/dota2/tournaments`
- **Requested path:** `/dota2/tournaments`
- **Reference URL:** https://developers.pandascore.co/reference/get_dota2_tournaments.md
...
- Collected at: 2026-09-02T10:37:53.362446Z
