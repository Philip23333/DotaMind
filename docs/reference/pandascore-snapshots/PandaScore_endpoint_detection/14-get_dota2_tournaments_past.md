...
- **Title:** Get past Dota 2 tournaments
- **Method:** GET
- **API path:** `/dota2/tournaments/past`
- **Requested path:** `/dota2/tournaments/past`
- **Reference URL:** https://developers.pandascore.co/reference/get_dota2_tournaments_past.md
...
- Collected at: 2026-09-02T10:37:54.876658Z
