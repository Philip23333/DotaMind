...
- **Title:** Get upcoming Dota 2 matches
- **Method:** GET
- **API path:** `/dota2/matches/upcoming`
- **Requested path:** `/dota2/matches/upcoming`
- **Reference URL:** https://developers.pandascore.co/reference/get_dota2_matches_upcoming.md
...
- Collected at: 2026-09-02T10:37:43.332186Z
