...
- **Title:** List Dota 2 series
- **Method:** GET
- **API path:** `/dota2/series`
- **Requested path:** `/dota2/series`
- **Reference URL:** https://developers.pandascore.co/reference/get_dota2_series.md
...
- Collected at: 2026-09-02T10:37:45.720908Z
