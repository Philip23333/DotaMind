...
- **Title:** Get past Dota 2 matches
- **Method:** GET
- **API path:** `/dota2/matches/past`
- **Requested path:** `/dota2/matches/past`
- **Reference URL:** https://developers.pandascore.co/reference/get_dota2_matches_past.md
...
- Collected at: 2026-09-02T10:37:40.072370Z
