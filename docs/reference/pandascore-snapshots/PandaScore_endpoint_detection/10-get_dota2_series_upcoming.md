...
- **Title:** Get upcoming Dota 2 series
- **Method:** GET
- **API path:** `/dota2/series/upcoming`
- **Requested path:** `/dota2/series/upcoming`
- **Reference URL:** https://developers.pandascore.co/reference/get_dota2_series_upcoming.md
...
- Collected at: 2026-09-02T10:37:49.357432Z
