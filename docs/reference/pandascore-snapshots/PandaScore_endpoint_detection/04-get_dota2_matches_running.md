...
- **Title:** Get running Dota 2 matches
- **Method:** GET
- **API path:** `/dota2/matches/running`
- **Requested path:** `/dota2/matches/running`
- **Reference URL:** https://developers.pandascore.co/reference/get_dota2_matches_running.md
...
- Collected at: 2026-09-02T10:37:41.900625Z
